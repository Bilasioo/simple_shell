...
/**
 * get_environ - function that returns string array copy of the environ
 * @info: Structure havinng potential arguments
 *
 * Return: Always 0
 *
 */
...
/**
 * _setenv - function that Initialize new environ var or modify existing ones
 * @info: Structure that has arguments
...
char _setenv(info_t *info, char *var, char *value)
{
	char *buff = NULL;
	list_t *node;
	char *q;
