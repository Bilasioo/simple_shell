...
/**
 * com_search - searches for directory where the given command is located
 * @command_name: name of the program to be searched
 *
 * Return: full path to directory that contains the program
 *
 */
