...
/**
 * _myexit - exits
 * @info: Structure that has possib;e arguments. Used to maintain constant function prototype.
 *  Return: exits with  exit statusm(0) when info.argv[0] != "exit"
 *
 */
 ...
 * @info: Structure that has pssible arguments. Used to maintain constant function prototype
 *  Return: Always 0
 *
 */
 ...
 * @info: Structure that has potential arguments maintains constant function prototype.
 *
 *  Return: Always 0
 *
 */
