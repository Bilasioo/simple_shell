 ...
 *@status: return status of lastexec'd command
 *struct passinfo - contains pseudo-arguements to pass into a function thus allowing uniform prototype for function pointer struct
 *
 */
